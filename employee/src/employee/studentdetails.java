...
public class studentdetails {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 596, 345);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		JLabel lblNewLabel = new JLabel("STUDENT DETAILS");
		lblNewLabel.setFont(new Font("Verdana", Font.BOLD, 12));
		lblNewLabel.setBounds(156, 11, 125, 14);
		...
		tb2 = new JTextField();
		tb2.setBounds(240, 113, 86, 20);
		frame.getContentPane().add(tb2);
		tb2.setColumns(10);
		
		JComboBox cb1 = new JComboBox();
		cb1.setModel(new DefaultComboBoxModel(new String[] {"SELECT", "CSE", "DS", "CS", "IOT", "IT", "ECE", "EEE"}));
		cb1.setBounds(240, 169, 86, 22);
		frame.getContentPane().add(cb1);
		
		tb3 = new JTextField();
		tb3.setBounds(240, 225, 86, 20);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/F5","root","mrec");
		...
		btnNewButton.setBounds(156, 272, 89, 23);
		frame.getContentPane().add(btnNewButton);
		
		JLabel lblNewLabel_5 = new JLabel("");
		lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\on line\\Desktop\\STUDENT.JPG.png"));
		lblNewLabel_5.setBounds(0, 0, 580, 306);
